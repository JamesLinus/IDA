...
$conn = mysql_connect("localhost", "root", "Ps371789");
mysql_select_db("IDA");
...
$g->select_command = "SELECT `users`.`userID`, `users`.`username`, `users`.`password`, `users`.`fystart`, `roles`.`role_name`\n"
    . "FROM `users`\n"
